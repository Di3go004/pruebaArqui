...
.find_newline:
    ...
    b.eq .replace_newline   // If newline found, go to replace
    cmp w2, #0              // Check if end of string (null terminator)
    b.eq .load_data_Open_file // If end of string, go to open file
...
.load_data_Read_File_loop2:
    ...
    bl atoi_partial         // Call atoi_partial to process numbers in the buffer
